...
$fieldMeta = [
    ...
    'aitoolsheading'         => ['label' => 'AI Tools Heading',          'icon' => '🤖', 'section' => 'Course Info'],
    'aitoolsdescription'     => ['label' => 'AI Tools Description',      'icon' => '💡', 'section' => 'Course Info'],
    ...
    'peoplesliderdesc'       => ['label' => 'People Slider Description', 'icon' => '👥', 'section' => 'Content'],
    ...
    'locationcity' => ['label' => 'Location course Name', 'icon' => '🔧', 'section' => 'Location'],
];
                  ...
                  <div class="field-card" style="--accent-color:<?= $accent ?>">
                    ...
                    <?php if (!$isEmpty): ?>
                      <button type="button" class="copy-btn"
                       onclick="copyField(this, <?= htmlspecialchars(json_encode($val), ENT_QUOTES) ?>)">📋</button>
                    <?php endif; ?>
                  </div>
